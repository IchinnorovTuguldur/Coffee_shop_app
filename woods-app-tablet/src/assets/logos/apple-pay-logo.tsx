...
export const ApplePayLogo = (props: LogoType) => {
  const { height, width, size, color, rawColor } = props;
  return (
    <Svg height={height || size || 800} width={width || size || 1200} viewBox="-76.791 -52.55 665.523 315.3" {...props}>
      <Path
        fill={color ? mapColorToBackground(color) : rawColor || '#000000'}
